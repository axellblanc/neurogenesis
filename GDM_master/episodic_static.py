...
class Episodic_N(GammaGWR):
    ...
    def init_network(self, ds, e_labels, num_context) -> None:
        ...
        self.num_nodes = 30 #ds.vectors.shape[0]
    ...
    def train_egwr(self, ds_vectors, ds_labels, epochs, a_threshold, beta, 
        ...
        self.tau_b = 0.3
        self.tau_n = 0.1
        self.max_nodes = 20#self.samples # OK for batch, bad for incremental
